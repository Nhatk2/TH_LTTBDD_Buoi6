...
const Item = ({ title,  shop, image }) => {
  return (
    <View style={{borderWidth:1, height:80, width:360, borderRadius:10}}>
     ...
     <Image source={image}
      ...
      <Text>{title}</Text>
         ...
         <Pressable style={{marginLeft:50,marginTop:20,backgroundColor:'red', justifyContent:'center', alignItems:'center', width:88, height:33}}><Text style={{color:'white'}}>Chat</Text></Pressable>
         </View>
    </View>
  );
};
